  ...
  return [
    {
      ...
      segments: [
        { transport: "BRT", from: origin, to: "Liberté 6", price_fcfa: 300, duration_min: 20 },
        { transport: "Car Rapide", from: "Liberté 6", to: destination, price_fcfa: 200, duration_min: 15 },
      ],
    },
    {
      id: "2",
      ...
      segments: [
        { transport: "Taxi Collectif", from: origin, to: destination, price_fcfa: 1500, duration_min: 25 },
      ],
    },
    {
      id: "3",
      ...
      total_price_fcfa: 300,
      nb_correspondances: 2,
      segments: [
        { transport: "Car Rapide", from: origin, to: "Petersen", price_fcfa: 150, duration_min: 25 },
        { transport: "Dakar Dem Dikk", from: "Petersen", to: "Gare Routière", price_fcfa: 100, duration_min: 20 },
        { transport: "Car Rapide", from: "Gare Routière", to: destination, price_fcfa: 150, duration_min: 10 },
      ],
    },
  ] as Array<{
    id: string;
